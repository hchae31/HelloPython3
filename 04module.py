...
# 협업 : 여러 개발자가 각각 모듈을 개발하고 함꼐사용
# 표준모듈 : 파이썬에서 기본적으로 제공하는 모듈
# 외무모듈 :  다른 조직, 개발자가 만든 모듈, 별도 설치 필요
# 사용자 정의 모듈 :  직접 만든 모듈
...
# result = '수급대상자' if (op.le(income, 4000000)) \
...
#
# print(f' 수심 {deeps} m - 수온 {temp} ℃') #특수기호 : ㄹ + '한자'키
