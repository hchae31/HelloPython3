...
# 정적static 자료형
# 변수선언시 자료형도 함께 지정 -
# 변수의 자료형은 실행시간 시간에 결정 - 콤파일 시간에 결정
# String name = '홍길동'
# name = 123 (오류발생!-선언시 자료형과  대입시 값의 자료형이 다름)

# 동적dynamic 자료형
# 변수선언시 자료형은 생략하능, 추론기능으로 자동할당
...
# 명시적explicit 변환 - 개발자가 직접 변환(int1, str, float, bool)
...
# print(type(int1), str(int1)) # 실행불가!

str6 = '3.14152'
#print(type(str6), str(str6), type(int(str6))) # 실행불가
...
# 변수명 = input(메세지)
# 주의! - input함수를 입력받은 값은 무조건 문자로 취급
